...
$caption = $img_link_large = $link = $img_link_target = $alignment = $el_class = $el_id = $css_animation = $style = $external_style = $border_color = $css = $animation_delay = '';
...
switch ( $onclick ) {
  ...
  case 'modal_zoom':
    $img['thumbnail'] = str_replace( '<img ', '<img data-action="zoom" ', $img['thumbnail'] );
    break;
...
$class_to_filter = 'wpb_single_image wpb_content_element vc_align_' . $alignment . ' ' . bezel_get_animation($css_animation, $animation_delay);
