...
<div class="wrap">
	...
	<div style="margin-left: -20px;position: relative" id="poststuff">
		...
		<form
			...
			<ul id="lightbox_type">
				<li>
					<label for="new_type" <?php if ( get_option('portfolio_gallery_lightbox_type') == 'new_type' ) {	echo 'class="active"';	} ?>>New Type
					<input type="checkbox" name="params[portfolio_gallery_lightbox_type]" id="new_type" <?php if ( get_option('portfolio_gallery_lightbox_type') == 'new_type' ) {	echo 'checked="checked"';	} ?> value="new_type">
                    </label>
				</li>
				<li>
                    <label for="old_type" <?php if ( get_option('portfolio_gallery_lightbox_type') == 'old_type' ) {	echo 'class="active"';	} ?>>Old Type
                        <input type="checkbox" name="params[portfolio_gallery_lightbox_type]" id="old_type" <?php if ( get_option('portfolio_gallery_lightbox_type') == 'old_type' ) {echo 'checked="checked"';} ?>  value="old_type">
                    </label>
				</li>
		...
		<div id="lightbox-options-list" class="unique-type-options-wrapper <?php if ( get_option('portfolio_gallery_lightbox_type') == 'old_type' ) {echo "active";} ?>">
            <div class="lightbox-options-block portfolio_lightbox_options_grey_overlay">
                <h3><?php echo __( 'Internationalization', 'portfolio-gallery' ); ?> <img src="<?php echo PORTFOLIO_GALLERY_IMAGES_URL.'/admin_images/portfolio-pro-icon.png'; ?>" class="portfolio_gallery_lightbox_pro_logo"></h3>
                <?php include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
                ?>
                <div class="has-background">
                    <label for="light_box_style"><?php echo __( 'Lightbox style', 'portfolio-gallery' ); ?></label>
                    <select id="light_box_style" name="params[portfolio_gallery_light_box_style]">
                        <option 'selected="selected">1</option>
                        <option <?php if ( $portfolio_gallery_get_option['portfolio_gallery_light_box_style'] == '2' ) {
                            echo 'selected="selected"';
                        } ?> value="2">2
                        </option>
                        <option <?php if ( $portfolio_gallery_get_option['portfolio_gallery_light_box_style'] == '3' ) {
                            echo 'selected="selected"';
                        } ?> value="3">3
                        </option>
                        <option <?php if ( $portfolio_gallery_get_option['portfolio_gallery_light_box_style'] == '4' ) {
                            echo 'selected="selected"';
                        } ?> value="4">4
                        </option>
                        <option <?php if ( $portfolio_gallery_get_option['portfolio_gallery_light_box_style'] == '5' ) {
                            echo 'selected="selected"';
                        } ?> value="5">5
                        </option>
                    </select>
                ...
                <div>
                    ...
                    <select id="light_box_transition" name="params[portfolio_gallery_light_box_transition]">
                        <option <?php if ( $portfolio_gallery_get_option['portfolio_gallery_light_box_transition'] == 'elastic' ) {
                            echo 'selected="selected"';
                        } ?> value="elastic"><?php echo __( 'Elastic', 'portfolio-gallery' ); ?></option>
                        <option <?php if ( $portfolio_gallery_get_option['portfolio_gallery_light_box_transition'] == 'fade' ) {
                            echo 'selected="selected"';
                        } ?> value="fade"><?php echo __( 'Fade', 'portfolio-gallery' ); ?></option>
                        <option <?php if ( $portfolio_gallery_get_option['portfolio_gallery_light_box_transition'] == 'none' ) {
                            echo 'selected="selected"';
                ...
                <div class="has-background">
                    ...
                    <input type="number" name="params[portfolio_gallery_light_box_speed]" id="light_box_speed"
                           value="800"
                           class="text">
                    <span>ms</span>
                </div>
                <div>
                    ...
                    <input type="number" name="params[portfolio_gallery_light_box_fadeout]" id="light_box_fadeout"
                           value="300"
                           class="text">
                    <span>ms</span>
                </div>
                <div class="has-background">
                    ...
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_title]"/>
                    <input type="checkbox"
                           id="light_box_title"  name="params[portfolio_gallery_light_box_title]" value="true"/>
                </div>
                <div>
                    <label for="light_box_opacity"><?php echo __( 'Overlay transparency', 'portfolio-gallery' ); ?></label>
                    <div class="slider-container">
                        <input name="params[portfolio_gallery_light_box_opacity]" id="light_box_opacity"
                ...
                <div class="has-background">
                    ...
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_open]"/>
                    <input type="checkbox"
                           id="light_box_open" name="params[portfolio_gallery_light_box_open]" value="true"/>
                </div>
                <div>
                    <label
                            for="light_box_overlayclose"></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_overlayclose]"/>
                    <input type="checkbox" id="light_box_overlayclose" checked="checked" name="params[portfolio_gallery_light_box_overlayclose]" value="true"/>
                </div>
                <div class="has-background">
                    <label for="light_box_esckey"><?php echo __( 'EscKey close', 'portfolio-gallery' ); ?></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_esckey]"/>
                    <input type="checkbox"
                           id="light_box_esckey" name="params[portfolio_gallery_light_box_esckey]" value="true"/>
                </div>
                <div>
                    <label for="light_box_arrowkey"><?php echo __( 'Keyboard navigation', 'portfolio-gallery' ); ?></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_arrowkey]"/>
                    <input type="checkbox"
                           id="light_box_arrowkey" name="params[portfolio_gallery_light_box_arrowkey]" value="true"/>
                </div>
                <div class="has-background">
                    <label for="light_box_loop"><?php echo __( 'Loop content', 'portfolio-gallery' ); ?></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_loop]"/>
                    <input type="checkbox"
                           id="light_box_loop"  checked="checked" name="params[portfolio_gallery_light_box_loop]" value="true"/>
                </div>
                <div>
                    <label for="light_box_closebutton"><?php echo __( 'Show close button', 'portfolio-gallery' ); ?></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_closebutton]"/>
                    <input type="checkbox"
                           id="light_box_closebutton" name="params[portfolio_gallery_light_box_closebutton]" value="true"/>
                </div>
            </div>
            <div class="lightbox-options-block portfolio_lightbox_options_grey_overlay">
                <h3><?php echo __( 'Dimensions', 'portfolio-gallery' ); ?><img src="<?php echo PORTFOLIO_GALLERY_IMAGES_URL.'/admin_images/portfolio-pro-icon.png'; ?>" class="portfolio_gallery_lightbox_pro_logo"></h3>

                <div class="has-background">
                    <label for="light_box_size_fix"><?php echo __( 'Popup size fix', 'portfolio-gallery' ); ?></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_size_fix]"/>
                    <input type="checkbox"
                           id="light_box_size_fix"  name="params[portfolio_gallery_light_box_size_fix]" value="true"/>
                </div>

                <div class="fixed-size">
                    <label for="light_box_width"><?php echo __( 'Popup width', 'portfolio-gallery' ); ?></label>
                    <input type="number" name="params[portfolio_gallery_light_box_width]" id="light_box_width"
                           value="769"
                           class="text">
                    <span>px</span>
                </div>
                ...
                <div class="has-background fixed-size">
                    ...
                    <input type="number" name="params[portfolio_gallery_light_box_height]" id="light_box_height"
                           value="500"
                           class="text">
                    <span>px</span>
                </div>
                ...
                <div class="not-fixed-size">
                    ...
                    <input type="number" name="params[portfolio_gallery_light_box_maxwidth]" id="light_box_maxwidth"
                           value="300"
                           class="text">
                    <span>px</span>
                </div>
                <div class="has-background not-fixed-size">
                    ...
                    <input type="number" name="params[portfolio_gallery_light_box_maxheight]" id="light_box_maxheight"
                           value="100"
                           class="text">
                    <span>px</span>
                </div>
                <div>
                    ...
                    <input type="number" name="params[portfolio_gallery_light_box_initialwidth]" id="light_box_initialwidth"
                           value=""
                           class="text">
                    <span>px</span>
                </div>
                <div class="has-background">
                    ...
                    <input type="number" name="params[portfolio_gallery_light_box_initialheight]"
            ...
            <div class="lightbox-options-block portfolio_lightbox_options_grey_overlay">
                <h3>Slideshow <img src="<?php echo PORTFOLIO_GALLERY_IMAGES_URL.'/admin_images/portfolio-pro-icon.png'; ?>" class="portfolio_gallery_lightbox_pro_logo"></h3>

                <div class="has-background">
                    <label for="light_box_slideshow"><?php echo __( 'Slideshow', 'portfolio-gallery' ); ?></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_slideshow]"/>
                    <input type="checkbox"
                           id="light_box_slideshow" name="params[portfolio_gallery_light_box_slideshow]" value="true"/>
                </div>
                <div>
                    <label
                            for="light_box_slideshowspeed"><?php echo __( 'Slideshow interval', 'portfolio-gallery' ); ?></label>
                    <input type="number" name="params[portfolio_gallery_light_box_slideshowspeed]"
                ...
                <div class="has-background">
                    ...
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_slideshowauto]"/>
                    <input type="checkbox"
                           id="light_box_slideshowauto" checked="checked" name="params[portfolio_gallery_light_box_slideshowauto]" value="true"/>
                </div>
                <div>
                    <label
                            for="light_box_slideshowstart"><?php echo __( 'Slideshow start button text', 'portfolio-gallery' ); ?></label>
                    <input type="text" name="params[portfolio_gallery_light_box_slideshowstart]"
                ...
                <div class="has-background">
                    ...
                    <input type="text" name="params[portfolio_gallery_light_box_slideshowstop]" id="light_box_slideshowstop"
                           value="Stop slideshow"
                           class="text">
                </div>
            </div>
            <div class="lightbox-options-block portfolio_lightbox_options_grey_overlay">
                <h3>Positioning <img src="<?php echo PORTFOLIO_GALLERY_IMAGES_URL.'/admin_images/portfolio-pro-icon.png'; ?>" class="portfolio_gallery_lightbox_pro_logo"></h3>

                <div class="has-background">
                    <label for="light_box_fixed"><?php echo __( 'Fixed position', 'portfolio-gallery' ); ?></label>
                    <input type="hidden" value="false" name="params[portfolio_gallery_light_box_fixed]"/>
                    <input type="checkbox"
                           id="light_box_fixed" checked="checked" name="params[portfolio_gallery_light_box_fixed]" value="true"/>
                </div>
                        ...
                        <table class="bws_position_table">
                            ...
                            <tr>
                                <td><input type="radio" value="1" id="slideshow_title_top-left"
                                           name="params[portfolio_gallery_slider_title_position]" /></td>
                            ...
                            <tr>
                                ...
                                <td><input type="radio" value="5" id="slideshow_title_middle-center"
                                           name="params[portfolio_gallery_slider_title_position]"checked="checked" /></td>
		...
		<div id="new-lightbox-options-list" class="unique-type-options-wrapper <?php if ( get_option('portfolio_gallery_lightbox_type') == 'new_type' ) {echo "active";} ?>">
