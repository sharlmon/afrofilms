...
<div class="free_version_banner" <?php if (isset($_COOKIE['portfolioGalleryBannerShow']) && $_COOKIE['portfolioGalleryBannerShow'] == "no") echo 'style="display:none"'; ?> >
    ...
    <p class="usermanual_text">If you have any difficulties in using the options, Follow the link to <a
                href="https://huge-it.com/wordpress-portfolio-gallery-user-manual/" target="_blank">User Manual</a></p>
    <a class="get_full_version" href="https://huge-it.com/portfolio-gallery/" target="_blank">GET THE FULL VERSION</a>
    ...
    <div class="hg_view_plugins_block">
        ...
        <a target="_blank" href="https://demo.huge-it.com/wordpress-plugins-portfolio-catalog">Full Demo</a>
