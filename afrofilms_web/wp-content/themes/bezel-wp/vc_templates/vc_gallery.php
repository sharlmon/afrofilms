...
$gal_class = 'wpb_gallery_slides';
$flex_fx = '';
$flex_opt = array('"controlNav": true', '"directionNav": true');

if ( 'flexslider' === $type || 'flexslider_fade' === $type || 'fading' === $type ) {
  $type = 'flexslider nav-inside';
  $flex_fx = ' data-options="{animation: "fade"}"';
  $gal_class = '';
} elseif ( 'flexslider_slide' === $type ) {
  $type = 'flexslider nav-inside';
  $flex_opt[] = '"animation": "slide"';
  $flex_fx = ' data-options="{'.htmlentities(implode(', ', $flex_opt)).'}"';
  $gal_class = '';
} elseif ( 'image_grid' === $type ) {
  $type = ' wpb_image_grid';
}
...
$output .= '<div class="'.$gal_class.'' . $type . '" data-interval="' . $interval . '"' . $flex_fx . '>' . $slides_wrap_start . $gal_images . $slides_wrap_end . '</div>';
$output .= '</div>';
$output .= '</div>';
